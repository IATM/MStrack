...
describe "enfermedad_actuals/new" do
  before(:each) do
    assign(:enfermedad_actual, stub_model(EnfermedadActual,
      :fuente_inf => "MyString",
      :duracion => 1,
  ...
  it "renders new enfermedad_actual form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => enfermedad_actuals_path, :method => "post" do
