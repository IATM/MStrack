...
describe "antecedentes/edit" do
  before(:each) do
    @antecedente = assign(:antecedente, stub_model(Antecedente,
      :patologicos => "",
      :autoinmunes => "",
      :neurologicos => "",
      :psiquiatricos => "",
  ...
  it "renders the edit antecedente form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => antecedentes_path(@antecedente), :method => "post" do
